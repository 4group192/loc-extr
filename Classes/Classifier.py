...
"""
    ...
    def plot(self):
        ...
        y0[y0 == -1.] = 0.
        if self.X.shape[1] == 2:
            fig = go.Figure(layout=go.Layout(title = {'text': 'График рассеивания и контурный график вероятности принадлежности к классу 1'}))
...
if __name__ == '__main__':
    #X, y = make_blobs(n_samples=1000, centers=2, n_features=2, center_box=(-10, 10))
