...
def page7():
    ...
    st.write('Приложение находит целочисленное решение задачи линейного программирования (max)')
    st.write('***')
    ...
    if st.checkbox('Показать инструкцию', value = True):
        ...
        st.write("""2. Задать коэффициенты целевой функциив в виде списка: [2,3]""")
        st.write("""3. Задать коэффициенты ограничений в виде массива: [[2,1], [1,4]]""")
        st.write("""4. Задать коэффициенты свободных членов ограничений в виде списка: [10, 13]""")
        st.write("""5. Нажать кнопку Click на боковой панели, результаты программы отобразятся ниже документации""")
