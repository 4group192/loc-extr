...
def page7():
    ...
    if st.checkbox('Показать инструкцию', value = True):
        ...
        st.write("""4. Задать коэффициенты ограничений в виде массива: [[2,1], [1,4]] -> 2x1+x2 <= b1, x1 + 4x2 <= b2""")
        st.write("""5. Задать коэффициенты свободных членов ограничений в виде списка: [10, 13] -> g1 <= 10, g2 <= 13""")
        st.write("""6. Нажать кнопку Click на боковой панели, результаты программы отобразятся ниже документации""")
